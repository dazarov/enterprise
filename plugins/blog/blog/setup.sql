...
select 'Creating PHOTOS table' AS '';
...
PRIMARY KEY (ID),
FOREIGN KEY (POST_ID) REFERENCES POSTS(ID) ON UPDATE SET NULL);

select 'Creating COMMENTS table' AS '';
...
FOREIGN KEY (PHOTO_ID) REFERENCES PHOTOS(ID) ON UPDATE SET NULL,
FOREIGN KEY (COMMENT_ID) REFERENCES COMMENTS(ID) ON UPDATE SET NULL);
