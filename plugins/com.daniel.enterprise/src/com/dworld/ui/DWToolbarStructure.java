...
public class DWToolbarStructure {
	...
	public List<DWToolbar> getPalette(){
		if(toolbars == null){
			...
			toolbar.buttons.add(new DWButton(Land.Mine_Grass, () -> config.setSelectedCode(Land.Mine_Grass)));
			toolbar.buttons.add(new DWButton(Land.Mine_Sand,  () -> config.setSelectedCode(Land.Mine_Sand)));
			toolbar.buttons.add(new DWButton());
			toolbar.buttons.add(new DWButton(Land.Peasant,       () -> config.setSelectedCode(Land.Peasant)));
			toolbar.buttons.add(new DWButton(Land.Peasant_Grass, () -> config.setSelectedCode(Land.Peasant_Grass)));
			toolbar.buttons.add(new DWButton(Land.Peasant_Sand,  () -> config.setSelectedCode(Land.Peasant_Sand)));
			toolbar.buttons.add(new DWButton());
			...
			toolbar.buttons.add(new DWButton(Land.BadGeneral_Grass, () -> config.setSelectedCode(Land.BadGeneral_Grass)));
			toolbar.buttons.add(new DWButton(Land.BadGeneral_Sand,  () -> config.setSelectedCode(Land.BadGeneral_Sand)));
			toolbar.buttons.add(new DWButton());
			toolbar.buttons.add(new DWButton(Land.BadOfficer,       () -> config.setSelectedCode(Land.BadOfficer)));
			toolbar.buttons.add(new DWButton(Land.BadOfficer_Grass, () -> config.setSelectedCode(Land.BadOfficer_Grass)));
			toolbar.buttons.add(new DWButton(Land.BadOfficer_Sand,  () -> config.setSelectedCode(Land.BadOfficer_Sand)));
			toolbar.buttons.add(new DWButton());
			toolbar.buttons.add(new DWButton(Land.BadSoldier,       () -> config.setSelectedCode(Land.BadSoldier)));
			toolbar.buttons.add(new DWButton(Land.BadSoldier_Grass, () -> config.setSelectedCode(Land.BadSoldier_Grass)));
			toolbar.buttons.add(new DWButton(Land.BadSoldier_Sand,  () -> config.setSelectedCode(Land.BadSoldier_Sand)));
			toolbar.buttons.add(new DWButton());
			toolbar.buttons.add(new DWButton(Land.BadTank,       () -> config.setSelectedCode(Land.BadTank)));
			toolbar.buttons.add(new DWButton(Land.BadTank_Grass, () -> config.setSelectedCode(Land.BadTank_Grass)));
			toolbar.buttons.add(new DWButton(Land.BadTank_Sand,  () -> config.setSelectedCode(Land.BadTank_Sand)));
			toolbar.buttons.add(new DWButton());
			toolbar.buttons.add(new DWButton(Land.BadBunker,       () -> config.setSelectedCode(Land.BadBunker)));
			toolbar.buttons.add(new DWButton(Land.BadBunker_Grass, () -> config.setSelectedCode(Land.BadBunker_Grass)));
			toolbar.buttons.add(new DWButton(Land.BadBunker_Sand,  () -> config.setSelectedCode(Land.BadBunker_Sand)));
			toolbar.buttons.add(new DWButton());
			toolbar.buttons.add(new DWButton(Land.BadRadar,       () -> config.setSelectedCode(Land.BadRadar)));
			toolbar.buttons.add(new DWButton(Land.BadRadar_Grass, () -> config.setSelectedCode(Land.BadRadar_Grass)));
			toolbar.buttons.add(new DWButton(Land.BadRadar_Sand,  () -> config.setSelectedCode(Land.BadRadar_Sand)));
			toolbar.buttons.add(new DWButton());
			...
			toolbar.buttons.add(new DWButton(Land.GoodGeneral_Grass, () -> config.setSelectedCode(Land.GoodGeneral_Grass)));
			toolbar.buttons.add(new DWButton(Land.GoodGeneral_Sand,  () -> config.setSelectedCode(Land.GoodGeneral_Sand)));
			toolbar.buttons.add(new DWButton());
			toolbar.buttons.add(new DWButton(Land.GoodOfficer,       () -> config.setSelectedCode(Land.GoodOfficer)));
			toolbar.buttons.add(new DWButton(Land.GoodOfficer_Grass, () -> config.setSelectedCode(Land.GoodOfficer_Grass)));
			toolbar.buttons.add(new DWButton(Land.GoodOfficer_Sand,  () -> config.setSelectedCode(Land.GoodOfficer_Sand)));
			toolbar.buttons.add(new DWButton());
			toolbar.buttons.add(new DWButton(Land.GoodSoldier,       () -> config.setSelectedCode(Land.GoodSoldier)));
			toolbar.buttons.add(new DWButton(Land.GoodSoldier_Grass, () -> config.setSelectedCode(Land.GoodSoldier_Grass)));
			toolbar.buttons.add(new DWButton(Land.GoodSoldier_Sand,  () -> config.setSelectedCode(Land.GoodSoldier_Sand)));
			toolbar.buttons.add(new DWButton());
			toolbar.buttons.add(new DWButton(Land.GoodTank,       () -> config.setSelectedCode(Land.GoodTank)));
			toolbar.buttons.add(new DWButton(Land.GoodTank_Grass, () -> config.setSelectedCode(Land.GoodTank_Grass)));
			toolbar.buttons.add(new DWButton(Land.GoodTank_Sand,  () -> config.setSelectedCode(Land.GoodTank_Sand)));
			toolbar.buttons.add(new DWButton());
			toolbar.buttons.add(new DWButton(Land.GoodBunker,       () -> config.setSelectedCode(Land.GoodBunker)));
			toolbar.buttons.add(new DWButton(Land.GoodBunker_Grass, () -> config.setSelectedCode(Land.GoodBunker_Grass)));
			toolbar.buttons.add(new DWButton(Land.GoodBunker_Sand,  () -> config.setSelectedCode(Land.GoodBunker_Sand)));
			toolbar.buttons.add(new DWButton());
			toolbar.buttons.add(new DWButton(Land.GoodRadar,       () -> config.setSelectedCode(Land.GoodRadar)));
			toolbar.buttons.add(new DWButton(Land.GoodRadar_Grass, () -> config.setSelectedCode(Land.GoodRadar_Grass)));
			toolbar.buttons.add(new DWButton(Land.GoodRadar_Sand,  () -> config.setSelectedCode(Land.GoodRadar_Sand)));
			toolbar.buttons.add(new DWButton());
