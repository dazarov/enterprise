...
public class AStarPathFinder implements PathFinder {
	 ...
	 */
	protected boolean isValidLocation(MovableUnit mover, int sx, int sy, int x, int y) {
	 ...
	 */
	public float getMovementCost(MovableUnit mover, int sx, int sy, int tx, int ty) {
	 ...
	 */
	public float getHeuristicCost(MovableUnit mover, int x, int y, int tx, int ty) {
