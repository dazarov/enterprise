...
//				DanielTestPlugin.getDefault().logError(ex);
			String reportMessage = "Caused by: java.lang.UnsupportedClassVersionError: org/jboss/tools/usage/event/UsageEventType : Unsupported major.minor version 52.0\n";
			Throwable base =  new UnsupportedClassVersionError(reportMessage);
           base.setStackTrace(Thread.currentThread().getStackTrace());
