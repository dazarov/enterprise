...
public class Engine extends Thread{
	...
	private ArrayList<IUnit> allUnits = new ArrayList<IUnit>();
...
//	public static Unit findUnit(Point location){
//		for (Unit unit: allUnits) {
//			if(location.equals(unit.getLocation()))
//				return unit;
//		}
//		return null;
//	}
...
//	private static void createHash(Frame panel){
//		DProgressMonitor progressMonitor = new DProgressMonitor(panel, "Hash creation...", allUnits.size());
//		allUnitMap = new HashMap<Point, Unit>();
//	    Unit element;
//		for (int i = 0; i < allUnits.size(); i++) {
//			progressMonitor.setProgress(i+1);
//			element = (Unit)allUnits.get(i);
//			allUnitMap.put(element.getLocation(), element);
//		}
//		progressMonitor.close();
//	}
	
	public IUnit findUnit(Point location){
	    IUnit[] units = slowFindUnit(location);
	    if(units.length > 0){
	    	return units[0];
	    }
	    return null;
