package com.daniel.algorithms.pathexample;
...
import com.daniel.algorithms.pathfinding.AStarPathFinder;
import com.daniel.algorithms.pathfinding.Path;
import com.daniel.algorithms.pathfinding.PathFinder;
...
public class PathTest extends JFrame {
	...
	public PathTest() {
		...
		try {
			tiles[GameMap.TREES] = ImageIO.read(getResource("res/trees.gif"));
			tiles[GameMap.GRASS] = ImageIO.read(getResource("res/grass.gif"));
			tiles[GameMap.WATER] = ImageIO.read(getResource("res/water.gif"));
			tiles[GameMap.TANK] = ImageIO.read(getResource("res/tank.gif"));
			tiles[GameMap.PLANE] = ImageIO.read(getResource("res/plane.gif"));
			tiles[GameMap.BOAT] = ImageIO.read(getResource("res/boat.gif"));
		} catch (IOException e) {
